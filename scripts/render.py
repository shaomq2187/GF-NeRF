    ...
    with ExitStack() as stack:
        ...
        with progress:
            for camera_idx in progress.track(range(cameras.size), description=""):
                ...
                # add for eval embedding
                if embedding_indices is not None:
                    camera_ray_bundle.rel_camera_indices = torch.ones_like(camera_ray_bundle.camera_indices) * embedding_indices[camera_idx]
                if crop_data is not None:
                ...
                for rendered_output_name in rendered_output_names:
                    ...
                    if rendered_output_name == 'oct_depth':
                        output_image = output_image.min() / output_image
                    elif rendered_output_name == 'depth':
                        output_image = apply_depth_colormap(output_image)
...
class RenderTrajectory:
    ...
    def main(self) -> None:
        ...
        print('[debug] render rendered_output_names:',self.rendered_output_names)
        ...
        if self.traj == "spiral":
            ...
            # camera_path_interpolated = get_interpolated_camera_path(camera_path, self.interpolation_steps)
            # camera_path = camera_path_interpolated
        ...
        print('embedding_indices:',self.embedding_indices)
