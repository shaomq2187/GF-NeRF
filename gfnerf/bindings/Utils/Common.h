...
#define CUDAInt64 torch::TensorOptions().dtype(torch::kInt64).device(torch::kCUDA)
...
#define CPUInt64 torch::TensorOptions().dtype(torch::kInt64).device(torch::kCPU)
...
#define CK_FLOAT(tensor) CHECK(tensor.is_floating_point() && tensor.dtype() == torch::kFloat32)
...
#define Wec2i64 Eigen::Vector2i64
#define Wec3i64 Eigen::Vector3i64
#define Wec4i64 Eigen::Vector4i64
