...
class Pipeline(nn.Module):
    ...
    def get_train_loss_dict(self, step: int):
        ...
        """
        if self.world_size > 1 and step:  # type: ignore
    ...
    def get_eval_loss_dict(self, step: int):
        ...
        """
        self.eval()
        if self.world_size > 1:  # type: ignore
    ...
    ) -> List[TrainingCallback]:  # type: ignore
        """Returns the training callbacks from both the Dataloader and the Model."""

    def get_param_groups(self) -> Dict[str, List[Parameter]]:  # type: ignore
