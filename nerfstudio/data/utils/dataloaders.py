...
class CacheDataloader(DataLoader):
    ...
    def _update_error_map(self,ray_indices,new_values):
        assert self.cached_collated_batch is not None
        self.cached_collated_batch['error_map'][ray_indices[:,0],ray_indices[:,1],ray_indices[:,2],:] = new_values.view(-1,1) # (n,h,w,1)
