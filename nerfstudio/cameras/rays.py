...
class Frustums(TensorDataclass):
    ...
    tree_node_idx:Optional[TensorType["bs":...,1]]=None
...
@dataclass
class WarpedSamples(TensorDataclass):
    sampled_world_pts: TensorType["n_rays":..., 3]
    sampled_pts: TensorType["n_rays":..., 3]  # positions in warped sapce
    sampled_dirs: TensorType["n_rays":..., 3]
    sampled_dists: TensorType["n_rays":..., 1]
    sampled_t: TensorType["n_rays":..., 1]
    sampled_anchors: TensorType["n_rays":..., 1]
    pts_idx_start_end: TensorType["n_rays":..., 2]
    first_oct_dis: TensorType["n_rays":..., 1]


@dataclass
class F2Frustums(Frustums):
    pts_idx_start_end: Optional[TensorType["bs":..., 1]] = None
    first_oct_dis: Optional[TensorType["n_rays":..., 1]] = None
...
class RaySamples(TensorDataclass):
    ...
    frustums: Frustums
    """Frustums along ray."""
    f2samples: Optional[WarpedSamples] = None

    camera_indices: Optional[TensorType["bs":..., 1]] = None
    """Camera index."""
   
    rel_camera_indices: Optional[TensorType["bs":..., 1]] = None
    """rel_camera_indices index.""" 
    ...
    times: Optional[TensorType["bs":..., 1]] = None
    """Times at which rays are sampled"""
    cur_step: Optional[TensorType[..., 1]] = None 
    cur_split_dataset_idx: Optional[TensorType[..., 1]] = None
    ...
    def get_weights(self, densities: TensorType[..., "num_samples", 1]) -> TensorType[..., "num_samples", 1]:
        ...
        return weights
    def get_weights_f2nerf(self, densities: TensorType[..., "num_samples", 1]):
        """Return weights based on predicted densities
...
class RayBundle(TensorDataclass):
    ...
    lookat_directions: TensorType[...,3]
    """Unit ray direction vector"""
    pixel_area: TensorType[..., 1]
    """Projected area of pixel a distance 1 away from origin"""
    camera_indices: Optional[TensorType[..., 1]] = None
    """Camera indices"""
    rel_camera_indices: Optional[TensorType[..., 1]] = None
    """Relative Camera indices according to the current stage"""
    ...
    """Times at which rays are sampled"""
    steps:Optional[TensorType[..., 1]] = None
    """Curr steps at which rays are sampled"""
